...
<?php echo $this->Form->create('Enquete'); ?>
	<fieldset>
		<legend><?php echo __('Edit Enquete'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Enquete.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Enquete.id'))); ?></li>
